...
func main() {
	coms := []commands.Command{commands.NewOverlapCommand(), commands.NewMapCommand(), commands.NewTrimCommand(),commands.NewSubSeqCommand(), commands.NewConsensusCommand(), commands.NewFullMonteCommand(),commands.NewKmersCommand()}
	if len(os.Args) == 1 {
